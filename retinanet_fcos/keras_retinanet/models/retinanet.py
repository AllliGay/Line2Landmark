...
def __create_pyramid_features(C3, C4, C5, feature_size=256):
    ...
    P3           = keras.layers.Conv2D(feature_size, kernel_size=3, strides=2, padding='same', name='P3')(P3)
    
    P4           = keras.layers.Conv2D(feature_size, kernel_size=1, strides=1, padding='same', name='C4_reduced')(C4)
    P4           = keras.layers.Add(name='P4_merged')([P3, P4])
    P4           = keras.layers.Conv2D(feature_size, kernel_size=3, strides=2, padding='same', name='P4')(P4)
    
    P5           = keras.layers.Conv2D(feature_size, kernel_size=1, strides=1, padding='same', name='C5_reduced')(C5)
    P5           = keras.layers.Add(name='P5_merged')([P4, P5])
...
def default_submodels(num_classes, num_anchors):
    ...
    """
    return [
        ('regression', default_regression_model(1)),
        ('classification', default_classification_model(1, 1))
    ]
...
def retinanet(
    ...
    output = [m(features) for n, m in submodels]
    return keras.models.Model(inputs=inputs, outputs=output, name=name)
