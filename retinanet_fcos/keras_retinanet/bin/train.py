...
def parse_args(args):
    ...
    parser.add_argument('--snapshot-path',   help='Path to store snapshots of models during training (defaults to \'./snapshots\')', default='/home/zjc793532302/retinanet/models')
    parser.add_argument('--tensorboard-dir', help='Log directory for Tensorboard output', default='/home/zjc793532302/retinanet/logs')
...
def main(args=None):
    ...
    print('-----------------------------------------------')
    print('dataset size:{}'.format(train_generator.size()))
    # create the model
    ...
    init_epoch = 0
    if args.snapshot:
        init_epoch = int(args.snapshot[-5:-3])
    # start training
